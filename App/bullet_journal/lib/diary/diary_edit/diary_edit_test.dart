...
class DiaryEditViewTest extends StatefulWidget {
  DiaryDB _diaryDB;
  int _state;
  DiaryEditViewTest(this._diaryDB, {int state = 2}) {
    this._state = state;
  }
  @override
...
class _DiaryEditViewTestState extends State<DiaryEditViewTest> {
  @override
  void initState() {
    super.initState();
        ...
        child: _images[index].getEditState
            ...
            : Draggable(
                ...
                onDraggableCanceled: (velocity, offset) {
                  // if (!_checkImageOffset(offset, _images[index].getSize))
                  //   return;
                  setState(() {
  ...
  //   );
  // }
  Widget _WidgetUnDrag(File imageFile, int index) {
    return GestureDetector(
      ...
      onPanUpdate: (details) {
        Size _mySize = Size(
            _images[index].getSize.width +
                details.localPosition.dx -
                _images[index].getOffset.dx,
            _images[index].getSize.height);
        _images[index].setSize(_mySize);
        setState(() {});
      },
      child: Container(
