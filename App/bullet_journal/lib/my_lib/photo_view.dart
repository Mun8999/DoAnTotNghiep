...
export '/my_lib/src/core/photo_view_gesture_detector.dart'
    show PhotoViewGestureDetectorScope;
export '/my_lib/src/photo_view_computed_scale.dart';
export '/my_lib/src/photo_view_scale_state.dart';
export '/my_lib/src/utils/photo_view_hero_attributes.dart';
